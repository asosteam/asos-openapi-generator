...
import static org.openapitools.codegen.utils.StringUtils.camelizeApplyingFormat;

public class SwiftASOSClientCodegen extends DefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(SwiftASOSClientCodegen.class);
    ...
    /**
     * Constructor for the swiftASOS language codegen module.
     */
    public SwiftASOSClientCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "swiftASOS";
    ...
    public String getHelp() {
        return "Generates a Swift client library following ASOS conventions.";
    }
    ...
    public String toModelName(String name) {
        return super.toModelName(name).replace("Asos", "ASOS");
    }
    ...
    public String toApiName(String name) {
        ...
        return camelizeApplyingFormat(apiNamePrefix + "_" + name) + "API";
    }
    ...
    public String toOperationId(String operationId) {
        return super.toOperationId(operationId).replace("Asos", "ASOS");
    }

    @Override
    public String toVarName(String name) {
        return super.toVarName(name).replace("Asos", "ASOS");
    }

    @Override
    public String toParamName(String name) {
        return super.toParamName(name).replace("Asos", "ASOS");
    }
        ...
        if (allDefinitions != null) {
            ...
            while (parentSchema != null) {
                ...
                final CodegenModel parentCodegenModel = super.fromModel(codegenModel.parent,
                        parentModel);
                codegenModel = SwiftASOSClientCodegen.reconcileProperties(codegenModel, parentCodegenModel);
    ...
    public String toEnumVarName(String name, String datatype) {
        ...
        if (enumUnknownDefaultCase) {
            if (name.equals(enumUnknownDefaultCaseName)) {
                return camelizeApplyingFormat(name, LOWERCASE_FIRST_LETTER);
            }
        }
        ...
        if (name.matches("\\d.*")) {
            return "_" + replaceSpecialCharacters(camelizeApplyingFormat(name, LOWERCASE_FIRST_LETTER));
        }

        // for symbol, e.g. $, #
        if (getSymbolName(name) != null) {
            return camelizeApplyingFormat(WordUtils.capitalizeFully(getSymbolName(name).toUpperCase(Locale.ROOT)), LOWERCASE_FIRST_LETTER);
        }

        // Camelize only when we have a structure defined below
        boolean camelized = false;
        if (name.matches("[A-Z][a-z0-9]+[a-zA-Z0-9]*")) {
            name = camelizeApplyingFormat(name, LOWERCASE_FIRST_LETTER);
            camelized = true;
        }
        ...
        if ("Int".equals(datatype) || "Int32".equals(datatype) || "Int64".equals(datatype)
            ...
            String varName = "number" + camelizeApplyingFormat(name);
        ...
        char[] separators = {'-', '_', ' ', ':', '(', ')'};
        return camelizeApplyingFormat(replaceSpecialCharacters(WordUtils.capitalizeFully(StringUtils.lowerCase(name), separators)
                        .replaceAll("[-_ :\\(\\)]", "")),
    ...
    public void postProcess() {
        ...
        System.out.println("#                                                                              #");
        System.out.println("# swiftASOS generator is contributed by Bruno Coelho (https://github.com/4brunu). #");
        ...
        System.out.println("#                                                                              #");
        System.out.println("# If you need help migrating from the swiftASOS to the swift6 generator, check the following url.#");
