...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/typescript-node-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/typescript-node-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/typescript-node-petstore';
