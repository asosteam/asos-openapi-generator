...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-browser-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/typescript-browser-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-browser-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/typescript-browser-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-browser-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/typescript-browser-petstore';
