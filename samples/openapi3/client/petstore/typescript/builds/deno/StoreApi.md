...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-deno-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/typescript-deno-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-deno-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/typescript-deno-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-deno-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/typescript-deno-petstore';
