...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-object-parameters-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/typescript-node-object-parameters-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-object-parameters-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/typescript-node-object-parameters-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-node-object-parameters-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/typescript-node-object-parameters-petstore';
