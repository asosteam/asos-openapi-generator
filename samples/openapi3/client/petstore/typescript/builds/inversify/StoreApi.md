...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-inversify-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/typescript-inversify-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-inversify-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/typescript-inversify-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/typescript-inversify-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/typescript-inversify-petstore';
