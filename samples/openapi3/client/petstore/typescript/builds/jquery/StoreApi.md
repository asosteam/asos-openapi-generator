...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/jquery-typescript-petstore';
import type { StoreApiDeleteOrderRequest } from '@openapitools/jquery-typescript-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/jquery-typescript-petstore';
import type { StoreApiGetOrderByIdRequest } from '@openapitools/jquery-typescript-petstore';
...
```typescript
import { createConfiguration, StoreApi } from '@openapitools/jquery-typescript-petstore';
import type { StoreApiPlaceOrderRequest } from '@openapitools/jquery-typescript-petstore';
